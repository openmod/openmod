...
{
    public class UnturnedPlayerBanEvent : Event
    {
        ...
        public UnturnedPlayerBanEvent(CSteamID instigator, CSteamID playerToBan, uint ipToBan, string reason, uint duration, bool shouldVanillaBan)
        {
